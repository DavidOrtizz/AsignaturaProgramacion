 ...
 * @curso: 1ºDAM Tarde
 * 
 * @descripcion: Queremos gestionar la venta de entradas (no numeradas) de Expocoches Campanillas que tiene 3 zonas, 
  ...
  public static void main(String[] args) {
    ...
    do {
      ...
      if (opcion == 2) {
          ...
          seleccion = s.nextLine();
          try {
            opcion2 = Integer.parseInt(seleccion);
          } catch (Exception e) {
            System.out.println("Opción no válida");
          }
